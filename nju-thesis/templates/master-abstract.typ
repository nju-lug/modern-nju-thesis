...
#let master-abstract(
  ...
  [
    ...
    #gridx(
      ...
      colspanx(2, info-key[指导教师（姓名、职称）：]), colspanx(4, info-value("supervisor", info.supervisor.at(0) + " " + info.supervisor.at(1) + h(1em) + info.supervisor-ii.at(0) + " " + info.supervisor-ii.at(1))),
    )
